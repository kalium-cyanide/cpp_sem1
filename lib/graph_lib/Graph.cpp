...
void Shape::draw() const {
  Fl_Color oldc = fl_color();  // there is no good portable way of
                               // retrieving the current style
...
// displayed at xy x coordinates are scaled by xscale and y coordinates
// scaled by yscale
{
